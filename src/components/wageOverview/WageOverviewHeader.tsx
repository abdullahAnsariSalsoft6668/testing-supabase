...
type WageOverviewHeaderProps = {
    avatarSource: ImageSourcePropType;
};

const WageOverviewHeader: React.FC<WageOverviewHeaderProps> = ({ avatarSource }) => {
        ...
        <View style={styles.wrapper}>
            <Animated.View style={navStyle}>
                <View style={styles.topRow}>
                    ...
                    <TextComp text="Wage Overview" style={styles.screenTitle} />
            ...
            <Animated.View style={heroStyle}>
                <TextComp text="Track your Wage" style={styles.heroTitle} />
                <TextComp
...
export default React.memo(WageOverviewHeader);
