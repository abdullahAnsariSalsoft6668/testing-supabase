...
type ExtraWorkHeaderProps = {
    avatarSource: ImageSourcePropType;
    onBack?: () => void;
};

const ExtraWorkHeader: React.FC<ExtraWorkHeaderProps> = ({ avatarSource, onBack }) => {
        ...
        <View style={styles.wrapper}>
            <Animated.View style={navStyle}>
                <View style={styles.topRow}>
                    ...
                    <TextComp text="Extra Work" style={styles.screenTitle} />
            ...
            <Animated.View style={heroStyle}>
                <TextComp text="Submit Extra Work" style={styles.heroTitle} />
                <TextComp
                    text="Submit additional routes completed outside your schedule."
...
export default React.memo(ExtraWorkHeader);
