...
type EditProfileScreenHeaderProps = {
    avatarSource: ImageSourcePropType;
};

const EditProfileScreenHeader: React.FC<EditProfileScreenHeaderProps> = ({ avatarSource }) => {
    ...
    return (
        <Animated.View style={[styles.wrapper, headerStyle]}>
            <View style={styles.topRow}>
                ...
                <TextComp text="Edit Profile" style={styles.screenTitle} />
...
export default React.memo(EditProfileScreenHeader);
